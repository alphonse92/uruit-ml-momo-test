/**
 * This function scroll to the end of the page of google images
 * {
 * onFinish,
 *      onError: callback when error,
 *      scrollDownClass = class namne that indetifies the button to trigger the "load more",
 *      scrollEndClass = class name that indetifies the label when the end is reached
 *      interval: each millisconds will the function try to reach the end,
 *      maxIntervals,
 * }
 * @param {obj} opts 
 */
...
// Example of ussage of all scripts
// 
